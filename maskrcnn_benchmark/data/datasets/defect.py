...
class defect(torch.utils.data.Dataset):
    ...
    def _normally_load_defect(self):
        ...
        print("defect.py | normally_load_defect | load data")
    ...
    def _load_img_from_NEW_and_OLD_cls(self):
        ...
        for w in range(len(total_classes)):
            ...
            print('defect.py | load_img_from_NEW_cls_without_old_data | number of images in {0}_{1} set: {2}'.format(
        ...
        print(
            'defect.py | load_img_from_NEW_and_OLD_cls_without_old_data | total used number of images in {0}: {1}'.format(
    ...
    def _load_img_from_NEW_cls_without_old_data(self):
        ...
        for incremental in self.new_classes:  # read corresponding class images from the data set
            ...
            print('defect.py | load_img_from_NEW_cls_without_old_data | number of images in {0}_{1} set: {2}'.format(incremental, self.image_set, len(img_ids_per_category)))
        ...
        # store image ids and class ids
        print('defect.py | load_img_from_NEW_cls_without_old_data | total used number of images in {0}: {1}'.format(
            self.image_set, len(self.final_ids)))
    ...
    def _load_img_from_old_cls_without_new_data(self):
        ...
        # for incremental in self.new_classes:
            ...
            print('defect.py | load_img_from_old_cls_without_new_data | number of images in {0}_{1} set: {2}'.format(incremental, self.image_set, len(img_ids_per_category)))
        ...
        # store image ids and class ids
        self.old_final_ids = self.final_ids
        print('defect.py | load_img_from_old_cls_without_new_data | total used number of images in {0}: {1}'.format(
    ...
    def map_class_id_to_class_name(self, class_id):
        if self.CTN == True:
            try:
                return defect.CLASSES[class_id+self.old_class_num]
            except:
                print("error")
        else:
            return defect.CLASSES[class_id ]
