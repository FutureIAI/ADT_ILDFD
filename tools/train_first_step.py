...
def train(cfg, local_rank, distributed):
    ...
    # 如果训练CTN,设置load_CTN=True
    extra_checkpoint_data = checkpointer.load(cfg.MODEL.WEIGHT,load_CTN=False)
...
def main():
    ...
    parser.add_argument(
        "-c", "--config_file",
        # default="/home/cgz/XWJ/CL/MMA-main/configs/Sampler_Incremental/e2e_faster_rcnn_R_50_C4_4x_source_model.yaml",
        default="/home/cgz/XWJ/CL/ADT-ILDFD/configs/Sampler_Incremental/e2e_faster_rcnn_R_50_C4_4x_target_model.yaml",
        metavar="FILE",
